...
const servicesData = [
  {
    ...
    desc: "Developing high-concept narratives, defining the brand voice, and writing the underlying scripts to hook investors and customers alike.",
    image: "/service_research.png",
  },
  {
    num: "02",
    title: "Pre-Production & Storyboarding",
    desc: "Creating shot-by-shot visual storyboards, casting voice/screen talent, and securing premium filming assets or virtual rendering setups.",
    image: "/service_production.png",
  },
  {
    num: "03",
    title: "Cinematic Production",
    desc: "Filming with cinema-grade cameras, professional lighting setups, and crisp audio capture, or rendering hyper-realistic 3D CGI.",
    image: "/service_packaging.png",
  },
  {
    num: "04",
    title: "VFX & Sound Design",
    desc: "Integrating state-of-the-art motion graphics, cinematic color grading, custom soundscapes, and audio mastering to maximize visual punch.",
    image: "/service_distribution.png",
  },
  {
    num: "05",
    title: "Launch Distribution & SEO",
    desc: "Encoding in multiple formats for web/social embedding, preparing thumbnail frames, and advising on release strategies to dominate the timeline.",
    ...
    <ThemeProvider>
      <div className="page-glow" style={{ minHeight: "100vh", position: "relative" }}>
        ...
        >
          ...
          >
            High-stakes visuals for high-stakes moments. Cinema-grade launch films and corporate assets designed to freeze the timeline and capture markets.
          </p>
